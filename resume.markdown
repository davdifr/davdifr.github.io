...
<section id="SUMMARY">
  <img align="right" width="120" height="120" src="/assets/qr-code.svg" />
  <div>
    <h3>SUMMARY</h3>
    <p>
...
<section id="SKILLS-AND-PROFICIENCY">
  <div>
    ...
    <ul>
      ...
      <li>
        Ethereum Blockchain:
        <ul>
          <li>Production-ready development of smart contracts in Solidity language.</li>
          <li>In-depth knowledge of the most commonly used standards such as ERC20 and ERC721.</li>
        </ul>
      </li>
    </ul>
  </div>
...
<section id="EDUCATION">
  <div>
    <h3>EDUCATION</h3>
    <ul>
      <li>Computer Science Degree at University of L'Aquila, Italy <i>(planned)</i>.</li>
    </ul>
    <h3>LANGUAGES</h3>
    <ul>
      <li>Italian <i>(mother tongue)</i> and English <i>(fluent)</i>.</li>
    </ul>
  </div>
</section>
